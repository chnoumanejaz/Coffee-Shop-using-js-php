...
<body>
    ...
    <nav class="nav">
      ...
      <div class="nav__navigation">
        <ul class="nav__list">
          ...
          <li class="nav__item">
            <a href="#" class="nav__link login-btn">Login
              <svg class="svg-white">
  ...
  <section class="model hidden">
    ...
    <div class="model__content">
      ...
      <button class="model__btn loginCheff">Login as a Cheff
        <svg class="svg-pri">
          <use xlink:href="img/sprite.svg#icon-login"></use>
        </svg>
      </button>
      <button class="model__btn loginAcc">Login as a Accountant
        <svg class="svg-pri">
          <use xlink:href="img/sprite.svg#icon-login"></use>
        </svg>
      </button>
      <button class="model__btn" id="Customer">Countinue as Customer</button>
    </div>
  </section>
