# Coffee Shop Website
This GitHub repository has a coffee shop website, with the integration of JavaScript, PHP, and MySQL.
...
```bash
  git clone https://github.com/chnoumanejaz/Coffee-Shop-using-js-php.git
```
Save it to your Php server directory Xampp or Wamp
...
# Have a look: (Demo)
https://bit.ly/coffeeShop-Nouman
